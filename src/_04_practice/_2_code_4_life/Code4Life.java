...
public class Code4Life {
    public static void main(String[] args) {
		...
		int hoursCoding = Integer.parseInt(JOptionPane.showInputDialog("How many hours have you spent coding this week? Please only input a number."));
		...
		else if (hoursCoding>=3 && hoursCoding<=5) {
